...
/***/ function(module, exports, __webpack_require__) {
	...
	var _basic = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Suggestions = __webpack_require__(168);
	...
	var ReactTagComplete = function (_React$Component) {
	  _inherits(ReactTagComplete, _React$Component);
	
	  function ReactTagComplete(props) {
	    _classCallCheck(this, ReactTagComplete);
	
	    var _this = _possibleConstructorReturn(this, (ReactTagComplete.__proto__ || Object.getPrototypeOf(ReactTagComplete)).call(this, props));
	  ...
	  _createClass(ReactTagComplete, [{
	    ...
	    value: function addTag(tag) {
	      ...
	      if (!this.props.allowDuplicates) {
	        ...
	        var matchingTag = this.props.tags.filter(function (existingTag) {
	    ...
	    value: function render() {
	      ...
	      var tags = this.props.tags.map(function (tag, i) {
	        return _react2.default.createElement(_Tag2.default, {
	          ...
	          onSelectTag: function onSelectTag(e) {
	            return _this2.selectTag(e, i);
	          }, isSelected: _this2.state.cursorPosition === _this2.props.tags.length - i });
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_input2.default, _extends({}, this.state, {
	            ref: function ref(c) {
	              _this2.input = c;
	            },
	            listboxId: listboxId,
	...
	ReactTagComplete.propTypes = {
	  ...
	  allowNew: _react2.default.PropTypes.bool,
	  allowDuplicates: _react2.default.PropTypes.bool
	};
	
	exports.default = ReactTagComplete;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (props) {
	  return React.createElement(
	    'div',
	    { className: props.classNames.selectedTag + (props.isSelected ? " selected" : ""), onClick: props.onSelectTag },
	    props.tag.name,
	    React.createElement(
	      'button',
	      { type: 'button', title: 'Click to remove tag', onClick: props.onDelete },
	      'X '
	    )
	  );
	};
	...
	var Input = function (_React$Component) {
	  ...
	  _createClass(Input, [{
	    ...
	    value: function render() {
	      ...
	      var listboxId = _props.listboxId;
	    ...
	    value: function render() {
	      ...
	      var options = this.state.options.map(function (item, i) {
	        ...
	        return React.createElement(
	          ...
	          React.createElement('span', { dangerouslySetInnerHTML: markIt(item.name, _this2.props.query) })
	        );
	      });
